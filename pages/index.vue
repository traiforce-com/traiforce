<template>
  ...
  index5
    ...
    <NuxtLink to="/info" class="text-blue-500 hover:underline ml-4">Go to Info Page</NuxtLink>
    <NuxtLink to="/top" class="text-blue-500 hover:underline ml-4">Go to Top Page</NuxtLink>
  </div>
</template>